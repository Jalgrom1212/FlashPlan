        ...
        <Card className="p-6 bg-card border-border max-w-lg mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Input type="number" min="0" step="0.1" value={distance} onChange={(e) => setDistance(e.target.value)} required className="w-full" />
            </div>
            <div>
            ...
            <div>
              ...
              <Input value={location} onChange={(e) => setLocation(e.target.value)} required className="w-full" />
            </div>
            <div>
            ...
            <div>
              ...
              <Input type="number" min="0" step="0.01" value={price} onChange={(e) => setPrice(Number(e.target.value))} className="w-full" />
            </div>
            <div>
